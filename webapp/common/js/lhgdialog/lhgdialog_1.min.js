...
; (function($, window, undefined) {
	...
	var lhgdialog = function(config, ok, cancel) {
		...
		_count++;
		return lhgdialog.list[config.id] = _box ? _box._init(config) : new lhgdialog.fn._init(config)
	};
	lhgdialog.fn = lhgdialog.prototype = {
		constructor: lhgdialog,
		_init: function(config) {
			var that = this,
			DOM, txt = config.content,
			...
			that.title(config.title).content(txt, true, isIfr).button(config.button).size(config.width, config.height).position(config.left, config.top).time(config.time)[config.show ? 'show': 'hide'](true).zindex().focus();
		...
		button: function() {
			...
			function(i, obj) {
				...
				button = !isNewButton ? listeners[name].elem: _doc.createElement('input');
		...
		size: function(width, height) {
			...
			if (width) {
				...
				if (width !== 'auto') wrapStyle.width = wrap.offsetWidth + 'px'
			}
			if (height) {
		...
		position: function(left, top) {
			...
			if (left || left === 0) {
				...
				} else if (typeof left === 'string') style.left = left
			}
			if (top || top === 0) {
				...
				} else if (typeof top === 'string') style.top = top
			}
		...
		lock: function() {
			...
			if (!mask) {
				frm = '<iframe style="width:98%;height:100%;position:absolute;top:0;left:0;z-index:-1;filter:alpha(opacity=0)"></iframe>';
				mask = _doc.createElement('div');
				mask.id = 'ldg_lockmask';
				mask.style.cssText = 'position:' + positionType + ';left:0;top:0;width:98%;height:100%;overflow:hidden;background:' + config.background + ';';
				$(mask).css({
		...
		get: function(id, object) {
			if (lhgdialog.list[id]) {
				...
				else return lhgdialog.list[id].iwin || null
			}
			return null
		},
		_iframe: function(url) {
			...
			loadCss = 'width:98%;height:100%;border:none 0;';
	...
	$(function() {
		...
		lhgdialog.setting.extendDrag && (function(dragEvent) {
			...
			style.cssText = 'display:none;position:' + positionType + ';left:0;top:0;width:98%;height:100%;cursor:move;filter:alpha(opacity=0);opacity:0;background:#FFF;pointer-events:none;';
			_doc.body.appendChild(mask);
	...
	lhgdialog.templates = '<table class="ui_border"><tbody><tr><td class="ui_lt"></td><td class="ui_t"></td><td class="ui_rt"></td></tr><tr><td class="ui_l"></td><td class="ui_c"><div class="ui_inner"><table class="ui_dialog"><tbody><tr><td colspan="2"><div class="ui_title_bar"><div class="ui_title" unselectable="on"></div><div class="ui_title_buttons"><a class="ui_min" href="javascript:void(0);" title="\u6700\u5C0F\u5316"><b class="ui_min_b"></b></a><a class="ui_max" href="javascript:void(0);" title="\u6700\u5927\u5316"><b class="ui_max_b"></b></a><a class="ui_res" href="javascript:void(0);" title="\u8FD8\u539F"><b class="ui_res_b"></b><b class="ui_res_t"></b></a><a class="ui_close" href="javascript:void(0);" title="\u5173\u95ED(esc\u952E)">\xd7</a></div></div></td></tr><tr><td class="ui_icon"><img class="ui_icon_bg"/></td><td class="ui_main" valign="middle"><div class="ui_content"  style="line-height:14px;"></div></td></tr><tr><td colspan="2"><div class="ui_buttons"></div></td></tr></tbody></table></div></td><td class="ui_r"></td></tr><tr><td class="ui_lb"></td><td class="ui_b"></td><td class="ui_rb"></td></tr></tbody></table>';
	lhgdialog.setting = {
	...
	lhgdialog.tipsp = function(content, time, icon, callback) {
		var reIcon = icon ?
		function() {
			this.DOM.icon_bg[0].src = this.config.path + 'skins/icons/' + icon;
			this.DOM.icon[0].style.display = '';
	...
	lhgdialog.tips1 = function(content, time, icon, callback) {
		var reIcon = icon ?
		function() {
			this.DOM.icon_bg[0].src = this.config.path + 'skins/icons/' + icon;
			this.DOM.icon[0].style.display = '';
